...
doctor1 = Doctor.create!(name: "Dr. John Adams", city: 'New York', specialization: 'Cardiology', cost_per_day: 100, description: 'Dr. John Adams is a cardiologist who specializes in heart disease. He is a certified heart surgeon and a member of the American Heart Association.')
doctor2 = Doctor.create!(name: "Dr. Robert Spear", city: 'New Jearsy', specialization: 'Nevrology', cost_per_day: 70, description: 'Dr. Dr. Robert Spear is a nevrologiest who specializes in heart disease. He is a certified heart surgeon and a member of the American Heart Association.')
doctor3 = Doctor.create!(name: "Dr. Bob Jones", city: 'Struga', specialization: 'Cardiology', cost_per_day: 150, description: 'Dr. Bob Jones is a cardiologist who specializes in heart disease. He is a certified heart surgeon and a member of the American Heart Association.')
